...
struct JpHotelView: View {
    ...
    var body: some View {
        ZStack {
            ...
            // Navigation triggers
            VStack {
                NavigationLink("", destination: JphotelimagesView(), isActive: $navigateToImages)
                    .hidden()
                NavigationLink("", destination: JpPlacesView(), isActive: $navigateToPlaces)
                    .hidden()
...
struct JpHotelView_Previews: PreviewProvider {

...
struct TownhouseView: View {
    ...
    var body: some View {
        ZStack {
            ...
            // Navigation triggers
            VStack {
                NavigationLink("", destination: TownhouseImageView(), isActive: $navigateToImages)
                    .hidden()
                NavigationLink("", destination: TownhousePlacesView(), isActive: $navigateToPlaces)
                    .hidden()
...
struct TownhouseView_Previews: PreviewProvider {

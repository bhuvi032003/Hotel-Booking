...
struct RainPlacesView: View {
        ...
        GeometryReader { geometry in
            ScrollView {
                VStack(spacing: 16) {
                    ...
                    NavigationLink(destination: RaintreeView(), isActive: $navigateToRooms) { EmptyView() }.hidden()
                    NavigationLink(destination: RaintreeimagesView(), isActive: $navigateToImages) { EmptyView() }.hidden()
    ...
    private func placeList(width: CGFloat) -> some View {
        VStack(alignment: .leading, spacing: 16) {
            ...
            VStack(spacing: 16) {
                PlaceItem(imageName: "itcplace", label: "Vivekanandar House", distance: "5 km", width: width)
                PlaceItem(imageName: "Arplace4", label: "Government Museum Chennai", distance: "6 km", width: width)
                PlaceItem(imageName: "splace4", label: "Marina Beach", distance: "4 km", width: width)
...
struct RainPlacesView_Previews: PreviewProvider {

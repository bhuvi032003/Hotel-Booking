...
struct Available: View {
    ...
    var body: some View {
            ...
            ZStack {
                ...
                VStack {
                    NavigationLink("", destination: saibabaimages(), isActive: $navigateToImages)
                       // .hidden()
                    NavigationLink("", destination: saibabaplaces(), isActive: $navigateToPlaces)
                        .hidden()
...
struct Available_Previews: PreviewProvider {

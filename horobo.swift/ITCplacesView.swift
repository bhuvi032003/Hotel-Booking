...
struct ITCplacesView: View {
    ...
    var body: some View {
        ZStack {
            ...
            NavigationLink(destination: ITCimagesView(), isActive: $navigateToImages) {
                EmptyView()
            }.hidden()
    ...
    private func placeList(width: CGFloat) -> some View {
        VStack(alignment: .leading, spacing: 16) {
            ...
            VStack(spacing: 16) {
                PlaceItem(imageName: "townhousePalce1", label: "Guindy National Park", distance: "0 m", width: width)
                PlaceItem(imageName: "itcplace", label: "Vivekanandar House", distance: "9 km", width: width)
                PlaceItem(imageName: "splace4", label: "Elliot's Beach", distance: "6 km", width: width)
                PlaceItem(imageName: "splace2", label: "Chennai Airport", distance: "4.3 km", width: width)
            }
        }
        .padding(.horizontal)
    }
...
struct ITCplacesView_Previews: PreviewProvider {
